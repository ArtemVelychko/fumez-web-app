...
export const NewMaterialSheet = () => {
  ...
  const handleCreateMaterial = useCallback(async (event: React.FormEvent<HTMLFormElement>) => {
  ...
  const content = (
    <form onSubmit={handleCreateMaterial} className="flex flex-col space-y-6 p-6">
      <InputField
        label="Title"
      ...
      <FragrancePyramidField
        ...
        onChange={(value) => handleInputChange("fragrancePyramid", value as string[])}
      />
